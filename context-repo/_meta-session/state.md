...
- SPEC-007 (`review`) — skill de onboarding `/init-framework`, implementada nesta sessão.
- SPEC-001, SPEC-008, SPEC-009 (`draft`) — ainda não implementadas.

## Reviews pendentes
- SPEC-002, SPEC-003, SPEC-004, SPEC-005, SPEC-006, SPEC-007 aguardando revisão humana
  para `approved`.

## Próximos passos
- Implementar SPEC-001 (validador), SPEC-008 (evals) e SPEC-009 (agentes de execução) —
  são as SPECs restantes de AYD-002.
